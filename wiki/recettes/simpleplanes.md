...
## Armor
**ID Technique** : `simpleplanes:armor` | **Machine** : `minecraft:crafting_shaped`
...
---
## Booster
**ID Technique** : `simpleplanes:booster` | **Machine** : `minecraft:crafting_shaped`
...
---
## Charging Station
**ID Technique** : `simpleplanes:charging_station` | **Machine** : `minecraft:crafting_shaped`
...
---
## Electric Engine
**ID Technique** : `simpleplanes:electric_engine` | **Machine** : `minecraft:crafting_shaped`

| Emplacement | Ingrédient | Icône |
| :--- | :--- | :--- |
| # | Ingots/Copper | ![ingots/copper](../images/simpleplanes_ingots/copper.png) |
| / | Rods/Blaze | ![rods/blaze](../images/simpleplanes_rods/blaze.png) |
| G | Propeller | ![propeller](../images/simpleplanes_propeller.png) |
| R | Storage Blocks/Redstone | ![storage_blocks/redstone](../images/simpleplanes_storage_blocks/redstone.png) |

---
## Floaty Bedding
**ID Technique** : `simpleplanes:floaty_bedding` | **Machine** : `minecraft:crafting_shaped`
...
---
## Folding
**ID Technique** : `simpleplanes:folding` | **Machine** : `minecraft:crafting_shaped`
...
---
## Furnace Engine
**ID Technique** : `simpleplanes:furnace_engine` | **Machine** : `minecraft:crafting_shaped`
...
---
## Healing
**ID Technique** : `simpleplanes:healing` | **Machine** : `minecraft:crafting_shaped`
...
---
## Helicopter
**ID Technique** : `simpleplanes:helicopter` | **Machine** : `simpleplanes:plane_workbench`

| Emplacement | Ingrédient | Icône |
| :--- | :--- | :--- |
| item | Propeller | ![propeller](../images/simpleplanes_propeller.png) |

---
## Large Plane
**ID Technique** : `simpleplanes:large_plane` | **Machine** : `simpleplanes:plane_workbench`
...
---
## Liquid Engine
**ID Technique** : `simpleplanes:liquid_engine` | **Machine** : `minecraft:crafting_shaped`
...
---
## Parachute
**ID Technique** : `simpleplanes:parachute` | **Machine** : `minecraft:crafting_shaped`
...
---
## Plane
**ID Technique** : `simpleplanes:plane` | **Machine** : `simpleplanes:plane_workbench`
...
---
## Plane Workbench
**ID Technique** : `simpleplanes:plane_workbench` | **Machine** : `minecraft:crafting_shaped`
...
---
## Propeller
**ID Technique** : `simpleplanes:propeller` | **Machine** : `minecraft:crafting_shaped`
...
---
## Seats
**ID Technique** : `simpleplanes:seats` | **Machine** : `minecraft:crafting_shaped`
...
---
## Shooter
**ID Technique** : `simpleplanes:shooter` | **Machine** : `minecraft:crafting_shapeless`
...
---
## Solar Panel
**ID Technique** : `simpleplanes:solar_panel` | **Machine** : `minecraft:crafting_shaped`
...
---
## Supply Crate
**ID Technique** : `simpleplanes:supply_crate` | **Machine** : `minecraft:crafting_shapeless`
...
---
## Wrench
**ID Technique** : `simpleplanes:wrench` | **Machine** : `minecraft:crafting_shaped`
